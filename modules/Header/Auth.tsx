...
export const Auth: FC<{ setOpen: Dispatch<SetStateAction<boolean>> }> = ({
  setOpen,
}) => {
  const login = Login();
        ...
        <TabsContent value="login">
          <Card className="bg-white border-none">
            ...
            <form onSubmit={handleLogin}>
              <CardContent className="space-y-2 mb-2 relative">
                ...
                <div className="space-y-2">
                  ...
                  <div
                    ...
                    className="cursor-pointer flex items-center absolute top-0 bottom-[-88px] my-auto right-[30px]"
                  >
              ...
              <CardFooter>
                <Button
                  className="border bg-black text-white duration-300 cursor-pointer hover:bg-[#282828]"
                  type="submit"
                >
                  Login
                </Button>
            ...
            <form onSubmit={handleRegister}>
              <CardContent className="space-y-2 mb-2">
                ...
                <div className="space-y-2 relative">
                  ...
                  <div
                    onClick={() => setShowPass(!showPass)}
                    className="cursor-pointer flex items-center absolute top-0 bottom-[-20px] my-auto right-2"
                  >
                    {showPass ? <FaEyeSlash size={20} /> : <FaEye size={20} />}
                  </div>
                </div>
