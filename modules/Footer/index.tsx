...
const Footer = () => {
  ...
  <div className="flex flex-col md:flex-row justify-between gap-10">
    <div className="w-full md:w-[400px]">
      <div className="mt-[40px]">
        ...
        <div className="flex gap-[10px] justify-center md:justify-start flex-wrap">
          <span className="p-3 bg-[#EBEFF3] rounded-[7px]"><FacebookIcon /></span>
          <span className="p-3 bg-[#EBEFF3] rounded-[7px]"><YoutubeIcon /></span>
          <span className="p-3 bg-[#EBEFF3] rounded-[7px]"><TelegramIcon /></span>
          <span className="p-3 bg-[#EBEFF3] rounded-[7px]"><TwitterIcon /></span>
          <span className="p-3 bg-[#EBEFF3] rounded-[7px]">
            <Image src="/assets/icons/instagram.svg" alt="alt" width={20} height={20} />
          </span>
        </div>
      </div>

      <div className="pt-[30px] text-center md:text-left">
        <h2 className="pb-[12px] text-[#000000B2] text-[18px] md:text-[20px] font-bold">Mobil ilovani yuklab oling</h2>
        <div className="flex flex-col sm:flex-row gap-[15px] items-center md:items-start justify-center md:justify-start mb-[30px]">
          <button className="flex items-center gap-[10px] bg-[#EBEFF3] py-[12px] px-[20px] rounded-[10px]">
            <AppStoreIcon /> <span className="text-[16px] font-bold">App Store</span>
          </button>
          <button className="flex items-center gap-[10px] bg-[#EBEFF3] py-[12px] px-[20px] rounded-[10px]">
            <GooglePlayIcon /> <span className="text-[16px] font-bold">Google Play</span>
          </button>
        </div>
    ...
    <div className="w-full md:w-[236px] mt-[30px] md:mt-[60px] text-center md:text-left">
      <h2 className="text-[#000000B2] text-[18px] md:text-[20px] font-bold mb-[18px]">Menyu</h2>
      <ul className="flex flex-col gap-[12px] text-[#000000B2]">
        <li><a href="">Ashyo haqida</a></li>
        <li><a href="">Foydalanish shartlari</a></li>
        <li><a href="">Maxfiylik va xavfsizlik siyosati</a></li>
        <li><a href="">Qaytarish siyosati</a></li>
        <li><a href="">Biz bilan aloqa</a></li>
      </ul>
    </div>
    <div className="w-full md:w-[350px] mt-[30px] md:mt-[60px]">
      <h2 className="text-[18px] md:text-[20px] font-bold text-center md:text-left">Aloqa</h2>
